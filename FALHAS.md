...
|---|---|---|---|
| 2026-08-21 | análise morreu com `503` do Gemini, mas o chat disse "o comando falhou: comprimindo pra analise..." — a cauda do log pegou linha de PROGRESSO do yt-dlp em vez do erro | pendente: filtrar progresso na `cauda()` do cli.rodar | infra |
