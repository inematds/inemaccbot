...
```
BOT_TOKEN=
QUEUE_DB=~/projetos/inemaccbot/inemaccbot.db
STATE_DIR=~/projetos/inemaccbot/state
LOG_FILE=~/projetos/inemaccbot/inemaccbot.log
ALLOWED_CHAT_IDS=
MOTOR_PADRAO=claude
...
Type=simple
User=<seu-usuario>
WorkingDirectory=~/projetos/inemaccbot
EnvironmentFile=~/projetos/inemaccbot/.env
